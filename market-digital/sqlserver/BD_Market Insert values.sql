...
('BEB-A13-0001', 'TE DHARAMSALA', 1, 18, 178),
('BEB-A20-0002', 'CERVEZA TIBETANA BARLEY', 1, 19, 141),
('CON-C12-0003', 'SIROPE DE REGALIZ', 2, 10, 32),
('CON-C11-0004', 'ESPECIAS CAJUN DEL CHEF ANTON', 2, 22, 16),
('CON-C31-0005', 'MEZCLA GUMBO DEL CHEF ANTON', 2, 21.35, 98),
('REP-B12-0006', 'MERMELADA DE GROSELLAS DE LA ABUELA', 7, 25, 15),
('FRU-F10-0007', 'PERAS SECAS ORGANICAS DEL TIO BOB', 3, 30, 185),
('CON-C21-0008', 'SALSA DE ARANDANOS NORTHWOODS', 2, 40, 196),
('CAR-R31-0009', 'BUEY MISHI KOBE', 4, 97, 127),
('PES-R10-000A', 'PEZ ESPADA', 5, 31, 92),
('LAC-Q24-000B', 'QUESO CABRALES', 6, 21, 84),
...
-- Cada detalle está asociado a una venta y un producto
